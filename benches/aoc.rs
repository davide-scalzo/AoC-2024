...
fn criterion_benchmark(c: &mut Criterion) {
    ...
    let day_4_input = get_day_4_input().unwrap();
    ...
    group.bench_function("day4 - p1", |b| b.iter(|| day4::part1(day_4_input.clone())));
    group.bench_function("day4 - p2", |b| b.iter(|| day4::part2(day_4_input.clone())));
    group.finish();
}
